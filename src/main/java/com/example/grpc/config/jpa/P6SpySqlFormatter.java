package com.example.grpc.config.jpa;
...
// P6Spy는 데이터베이스 쿼리와 관련된 모든 활동을 로깅하여 개발자가 SQL 쿼리를 모니터링하고 성능을 분석할 수 있도록 돕습니다.
...
public class P6SpySqlFormatter implements MessageFormattingStrategy {
    ...
    private String formatSql(String category, String sql) {
        if (sql == null && !sql.trim().isEmpty() && Category.STATEMENT.getName().equals(category)) {
             ...
             if(trimmedSQL.startsWith("create") || trimmedSQL.startsWith("after") || trimmedSQL.startsWith("comment")){
